    ...
    <div class="container">
        ...
        <div class="col-md-8">
            <div class="left-side-container">
                <div class="freelance-image"><a href="company-detail.html"><img src="assets/img/can-5.jpg"
                            class="img-responsive img-circle" alt=""></a></div>
                <div class="header-details">
                    <h4>Janelia Fragrintio<span class="pull-right">$44/hr</span></h4>
                    <p>Full Stack PHP Developer</p>
                    <ul>
                        <li><a href="#"><i class="fa fa-building"></i> Mack Star</a></li>
                        <li>
        ...
        <div class="col-md-4 bl-1 br-gary">
            <div class="right-side-detail">
                <ul>
                    <li><span class="detail-info">Availability</span>Full Time<span
                            class="available-status">Available</span></li>
        ...
        <div class="col-md-8 col-sm-8">
            <div class="container-detail-box">
                ...
                <div class="apply-job-header">
                    ...
                    <a href="company-detail.html" class="cl-success"><span><i class="fa fa-building"></i>App
                            Developer</span></a>
                ...
                <a href="#" class="btn btn-success">Shortlist</a>
            ...
            <div class="sidebar-wrapper">
                ...
                <div class="member-profile-list">
                    <div class="member-profile-thumb">
                        <a href="company-detail.html"><img src="assets/img/can-2.png" class="img-responsive img-circle"
                                alt="" /></a>
                    </div>
                ...
                <div class="member-profile-list">
                    <div class="member-profile-thumb">
                        <a href="company-detail.html"><img src="assets/img/can-3.png" class="img-responsive img-circle"
                                alt="" /></a>
                    </div>
                    <div class="member-profile-detail">
                        <h4><a href="company-detail.html">Adam Crivatinly</a></h4>
                ...
                <div class="member-profile-list">
                    <div class="member-profile-thumb">
                        <a href="company-detail.html"><img src="assets/img/can-1.png" class="img-responsive img-circle"
                                alt="" /></a>
                    </div>
                    <div class="member-profile-detail">
                        <h4><a href="company-detail.html">Adam Crivatinly</a></h4>
