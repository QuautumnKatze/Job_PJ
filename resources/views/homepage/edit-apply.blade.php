                        ...
                        <section class="full-detail">
                            <div class="container">
                                <div class="row bottom-mrg extra-mrg">
                                    <form id="updateByOwnedCV"
                                        action="{{route('homepage.apply-update', $apply->application_id)}}"
                                        method="POST">
                                        @csrf
                                                ...
                                                <select name="cv_id" class="form-control input-lg">
                                                    ...
                                                    @else
                                                        @foreach ($cvdata as $cv)
                                                            <option value="{{$cv->cv_id}}" {{$apply->cv_id == $cv->cv_id ? "selected" : ""}}>{{$cv->cv_name}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                @if ($cvdata->isEmpty())
                                                    <button type="submit" class="btn btn-success btn-primary small-btn"
                                                        ...
                                                        tuyển</button>
                                                @else
                                                    <button type="submit" class="btn btn-success btn-primary small-btn">Lưu
                                                        chỉnh sửa</button>
                                                @endif
                                        ...
                                        <div class="col-md-10 col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="cv_path" name="cv_path" class="form-control"
                                                    value="{{$apply->cv->cv_path}}" required="" readonly="">
                                            </div>
                                        ...
                                        <div class="row bottom-mrg extra-mrg">
                                            <div class="col-md-12">
                                                <button type="submit" id="submitBtn2"
                                                    class="btn btn-success btn-primary small-btn" disabled>Lưu chỉnh
                                                    sửa</button>
                                            </div>
                                        </div>
                                    </form>
...
<script>
    $(document).ready(function () {
        $('#updateByOwnedCV').on('submit', function (e) {
            e.preventDefault();
    ...
    $(document).ready(function () {
        $('#updateByUploadCV').on('submit', function (e) {
            e.preventDefault();
