                        ...
                        <div class="brows-job-list">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="brows-job-link">
                                    <a href="{{route('homepage.job-detail', $job->job_id)}}" class="btn btn-default">Xem</a>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function () {
        $('#searchForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route("homepage.search-jobs") }}',
                method: 'GET',
                data: {
                ...
                success: function (response) {
                    ...
                    if (response.length > 0) {
                            ...
                            <div class="item-click">
                                <article>
                                    <div class="brows-job-list">
                                        <div class="col-md-1 col-sm-2 small-padding">
                                            <div class="brows-job-company-img">
                                                <a href="/job-detail/${job.job_id}"><img
                                                    src="${job.recruiter.account.avatar}" class="img-responsive" alt="" /></a>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-5">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <div class="brows-job-link">
                                                <a href="/job-detail/${job.job_id}" class="btn btn-default">Xem</a>
                                            </div>
                                        </div>
                                    </div>
                                    <span class="tg-themetag tg-featuretag">Premium</span>
                        ...
                        $('#list').html('<p>Không tìm thấy công việc phù hợp.</p>');
                    }
                },
                error: function () {
