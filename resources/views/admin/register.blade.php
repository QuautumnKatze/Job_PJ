        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="registerForm" class="mb-3" action="{{route('register.submit')}}" method="POST">
              @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="fuil_name" class="form-label">Tên đầy đủ</label>
                  <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Nhập họ tên của bạn" required/>
                  <span id="fullNameFeedback" style="color: red;"></span>
                </div>
      ...
      $(document).ready(function () {
        ...
        $('#full_name').on('keyup', function () {
          ...
          if (full_name.length === 0) {
            ...
            $('#fullNameFeedback').text('Tên đầy đủ phải nhiều hơn 5 ký tự').css('color', 'red');
          } else {
            $('#fullNameFeedback').text('Tên hợp lệ').css('color', 'green');
          }
        });
          ...
          $.ajax({
            ...
            error: function (response) {
              if (response.status === 422) {
                ...
                if (errors.full_name) {
                  $('#fullNameFeedback').text(errors.full_name[0]);
                  toastr.error('Đăng ký thất bại. Vui lòng thử lại.');
                }
                if (errors.user_name) {
                  $('#userNameFeedback').text(errors.user_name[0]);
                  toastr.error('Đăng ký thất bại. Vui lòng thử lại.');
                }
                if (errors.email) {
